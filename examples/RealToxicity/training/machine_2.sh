...
python soft_risk_ppo_auth2_seed2.py \
        --input_query_size="more" \
        --ppo_config.exp_name="alhpa 0.2 RA-RLHF; seed 4 Real_toxicity 2x" \
        --prompt_len=32 \
        --generation_kwargs_min_length=32 \
        --generation_kwargs_max_new_tokens=32 \
        --ppo_config.seed=4 \
...
python soft_risk_ppo_auth2_seed2.py \
        --input_query_size="more" \
        --ppo_config.exp_name="alhpa 0.2 RA-RLHF; seed 56 Real_toxicity 2x" \
        --prompt_len=32 \
        --generation_kwargs_min_length=32 \
        --generation_kwargs_max_new_tokens=32 \
        --ppo_config.seed=56 \
...
python soft_risk_ppo_auth2_seed2.py \
        --input_query_size="more" \
        --ppo_config.exp_name="alhpa 0.2 RA-RLHF; seed 92 Real_toxicity 2x" \
        --prompt_len=32 \
        --generation_kwargs_min_length=32 \
        --generation_kwargs_max_new_tokens=32 \
        --ppo_config.seed=92 \
