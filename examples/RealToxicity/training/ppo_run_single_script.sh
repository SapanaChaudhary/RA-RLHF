...
python ppo_auth2.py \
         --input_query_size="more" \
         --ppo_config.exp_name="Fixed RLHF" \
         --ppo_config.no_adap_kl_ctrl \
         --generation_kwargs_min_length=32 \
         --generation_kwargs_max_new_tokens=32 \
         --ppo_config.seed=42
...
# python ppo_auth2.py \
#          --input_query_size="more" \
#          --ppo_config.exp_name="RLHF Penultimate 20,32 with trl parameters; seed=42; sft_both" \
#          --generation_kwargs_min_length=32 \
#          --generation_kwargs_max_new_tokens=32 \
#          --ppo_config.seed=42
...
# python ppo_auth2.py \
#          --input_query_size="more" \
#          --ppo_config.exp_name="20,32 with trl parameters; seed=0" \
#          --generation_kwargs_min_length=32 \
#          --generation_kwargs_max_new_tokens=32 \
#          --ppo_config.seed=0
...
# python ppo_auth2.py \
#          --input_query_size="more" \
#          --ppo_config.exp_name="20,32 with trl parameters; seed=36" \
#          --generation_kwargs_min_length=32 \
#          --generation_kwargs_max_new_tokens=32 \
#          --ppo_config.seed=36
