...
python soft_risk_ppo_auth2_2.py \
         --input_query_size="more" \
         --ppo_config.exp_name=" RA-RLHF Final - 20,32 with with trl parameters + rl4lm gen; seed=42; sft_both; n=1 " \
         --generation_kwargs_min_length=32 \
         --generation_kwargs_max_new_tokens=32 \
         --ppo_config.seed=42 \
         --risk_scheduler="new" \
...
# python soft_risk_ppo_auth2_2.py \
#          --input_query_size="more" \
#          --ppo_config.exp_name="20,32 with with trl parameters + rl4lm gen; seed=0" \
#          --generation_kwargs_min_length=32 \
#          --generation_kwargs_max_new_tokens=32 \
#          --ppo_config.seed=0
...
# python soft_risk_ppo_auth2_2.py \
#          --input_query_size="more" \
#          --ppo_config.exp_name="20,32 with with trl parameters + rl4lm gen; seed=36" \
#          --generation_kwargs_min_length=32 \
#          --generation_kwargs_max_new_tokens=32 \
#          --ppo_config.seed=36
