...
# sft = only on positive data
python soft_risk_ppo_auth1_2.py \
         --input_query_size="more" \
         --ppo_config.exp_name="seed=42; sft = p; n=240; alpha = 0.2; rho=0.98" \
...
python soft_risk_ppo_auth1_2.py \
         --input_query_size="more" \
         --ppo_config.exp_name="seed=42; sft = p; n=1; alpha = 0.2; rho=0.98" \
         --generation_kwargs_min_length=48 \
         --generation_kwargs_max_new_tokens=48 \
         --ppo_config.seed=42 \
         --risk_scheduler="new" \
...
python soft_risk_ppo_auth1_2.py \
         --input_query_size="more" \
         --ppo_config.exp_name="seed=42; sft = p; n=70; alpha = 0.2; rho=0.98" \
         --generation_kwargs_min_length=48 \
         --generation_kwargs_max_new_tokens=48 \
         --ppo_config.seed=42 \
         --risk_scheduler="new" \
