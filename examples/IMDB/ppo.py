...
os.makedirs(f'/mnt/shared-scratch/Anon1/auth1/rlhf/trl/logs/ppo/{date_n_time}')
torch.save(model, f'/mnt/shared-scratch/Anon1/auth1/rlhf/trl/logs/ppo/{date_n_time}/model.pt')
...
for ii in range(len(train_stats_lists)):
    pickle.dump(train_stats_lists[ii], open(f'/mnt/shared-scratch/Anon1/auth1/rlhf/trl/logs/ppo/{date_n_time}/{train_stats_lists_names[ii]}', "wb"))
