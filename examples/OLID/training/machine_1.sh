...
python ppo_auth2_seed2.py \
        --input_query_size="more" \
        --ppo_config.exp_name="RLHF; seed 4 OLID correct" \
        --prompt_len=8 \
...
python ppo_auth2_seed2.py \
        --input_query_size="more" \
        --ppo_config.exp_name="RLHF; seed 56 OLID correct" \
        --prompt_len=8 \
        --generation_kwargs_min_length=22 \
        --generation_kwargs_max_new_tokens=22 \
        --ppo_config.seed=56
python ppo_auth2_seed2.py \
        --input_query_size="more" \
        --ppo_config.exp_name="RLHF; seed 92 OLID correct" \
        --prompt_len=8 \
        --generation_kwargs_min_length=22 \
        --generation_kwargs_max_new_tokens=22 \
        --ppo_config.seed=92
...
# python ppo_auth2_seed2.py \
#         --input_query_size="more" \
#         --ppo_config.exp_name="RLHF; seed 56 70/30" \
#         --prompt_len=8 \
#         --generation_kwargs_min_length=32 \
#         --generation_kwargs_max_new_tokens=32 \
#         --ppo_config.seed=56
